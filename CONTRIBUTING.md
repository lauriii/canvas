...
11. If you want to run *all* tests locally: `composer require jangregor/phpstan-prophecy league/openapi-psr7-validator webflo/drupal-finder devizzent/cebe-php-openapi --dev && composer update`
