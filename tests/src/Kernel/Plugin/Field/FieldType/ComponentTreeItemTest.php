...
class ComponentTreeItemTest extends KernelTestBase {
  ...
  public function testCalculateDependencies(): void {
    ...
    Component::create([
      ...
      'id' => Component::convertMachineNameToId('experience_builder:image'),
    ...
    $autogenerated_component = Component::load(Component::convertMachineNameToId('sdc_test:my-cta'));
    assert($autogenerated_component instanceof Component);
    $autogenerated_component->delete();
    Component::create([
      'label' => $this->randomString(),
      'id' => Component::convertMachineNameToId('sdc_test:my-cta'),
