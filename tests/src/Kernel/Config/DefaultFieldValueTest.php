...
class DefaultFieldValueTest extends CanvasKernelTestBase {
  ...
  public static function providerDefaultFieldValue(): array {
    ...
    array_push(
      ...
      SchemaIncompleteException::class,
      version_compare(\Drupal::VERSION, '11.4', '>=')
        ? 'Schema errors for field.field.node.article.field_canvas_test with the following errors: field.field.node.article.field_canvas_test:default_value.0.inputs.heading-2 missing schema, field.field.node.article.field_canvas_test:default_value.1.inputs.heading-1 missing schema, 0 [default_value.0.inputs.9145b0da-85a1-4ee7-ad1d-b1b63614aed6.heading-2] Component `9145b0da-85a1-4ee7-ad1d-b1b63614aed6`: the `heading-2` prop is not defined., 1 [default_value.0.inputs.9145b0da-85a1-4ee7-ad1d-b1b63614aed6.heading] The property heading is required., 2 [default_value.0] The &#039;entity-field&#039; prop source type must be absent., 3 [default_value.0.inputs.heading-2] &#039;heading-2&#039; is not a supported key., 4 [default_value.0.inputs] &#039;heading&#039; is a required key., 5 [default_value.1.inputs.dab1145b-c5d5-4779-9be8-0a41c2d8ed29.heading-1] Component `dab1145b-c5d5-4779-9be8-0a41c2d8ed29`: the `heading-1` prop is not defined., 6 [default_value.1.inputs.dab1145b-c5d5-4779-9be8-0a41c2d8ed29.heading] The property heading is required., 7 [default_value.1] The &#039;entity-field&#039; prop source type must be absent., 8 [default_value.1.inputs.heading-1] &#039;heading-1&#039; is not a supported key., 9 [default_value.1.inputs] &#039;heading&#039; is a required key., 10 [default_value.2] The &#039;entity-field&#039; prop source type must be absent.'
