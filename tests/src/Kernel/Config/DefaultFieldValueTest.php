...
class DefaultFieldValueTest extends KernelTestBase {
  ...
  public static function providerDefaultFieldValue(): array {
    ...
    array_push($test_cases['invalid values using dynamic props'], SchemaIncompleteException::class, 'Schema errors for field.field.node.article.field_xb_test with the following errors: 0 [default_value.0] The &#039;dynamic&#039; prop source type must be absent.');
    // Ensure the props validation is enforced even if the root is invalid.
    array_push($test_cases['props invalid, using only static props'], SchemaIncompleteException::class, 'Schema errors for field.field.node.article.field_xb_test with the following errors: 0 [default_value.0.props.static-card2df.heading] The property heading is required');
    ...
    array_push($test_cases['props invalid, using dynamic props'], SchemaIncompleteException::class, 'Schema errors for field.field.node.article.field_xb_test with the following errors: 0 [default_value.0] The &#039;dynamic&#039; prop source type must be absent.');
