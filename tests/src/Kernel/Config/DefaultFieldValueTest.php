...
class DefaultFieldValueTest extends KernelTestBase {
  ...
  public static function providerDefaultFieldValue(): array {
    ...
    array_push($test_cases['invalid tree: the main content block is only allowed in PageTemplate'], SchemaIncompleteException::class, 'Schema errors for field.field.node.article.field_xb_test with the following errors: 0 [default_value.0] The &#039;Drupal\Core\Block\MainContentBlockPluginInterface&#039; component interface must be absent.');
