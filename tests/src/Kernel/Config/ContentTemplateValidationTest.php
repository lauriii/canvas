...
final class ContentTemplateValidationTest extends BetterConfigEntityValidationTestBase {
    ...
    $this->entity = ContentTemplate::create([
      ...
      'component_tree' => [
        [
          ...
          'component_version' => 'd77d3282e5bcfff1',
          'inputs' => [
            'text' => [
        ...
        [
          ...
          'component_version' => '09de16f3d27b433f',
          'inputs' => [
            'text' => [
              'sourceType' => 'dynamic',
  ...
  public static function providerInvalidComponentTree(): \Generator {
    ...
    yield "using AdaptedPropSource" => [
      'component_tree' => [
        ...
        [
          ...
          'component_version' => 'd3c06a53d74684d0',
          'inputs' => [
            'image' => [
    ...
    yield "invalid version" => [
      ...
      'expected_messages' => [
        'component_tree.0.component_version' => "'abc' is not a version that exists on component config entity 'sdc.xb_test_sdc.props-slots'. Available versions: 'c8a016671696090c'.",
      ],
    ];
  }
