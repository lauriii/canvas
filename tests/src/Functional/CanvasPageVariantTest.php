...
class CanvasPageVariantTest extends FunctionalTestBase {
  ...
  public function test(): void {
    ...
    self::assertSame([
      'Using a static prop source that deviates from the configuration for Component <em class="placeholder">sdc.canvas_test_sdc.props-slots</em> at version <em class="placeholder">cc56dff72ca26013</em>.',
    ], \array_map(
