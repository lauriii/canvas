      ...
      'sdc.sdc_test_all_props.all-props' => [
        ...
        'dynamic_prop_source_candidates' => [
          ...
          'test_string_format_uri' => [
            "Subset of this Article's Image: entity (1 of 5 props — absent: alt, title, width, height)" => 'ℹ︎␜entity:node:article␝field_image␞␟entity␜␜entity:file␝uri␞␟value',
          ],
          ...
          'test_integer' => [
            ...
            "Subset of this Article's Comments: cid (1 of 6 props — absent: status, last_comment_timestamp, last_comment_name, last_comment_uid, comment_count)" => 'ℹ︎␜entity:node:article␝comment␞␟cid',
            "Subset of this Article's Comments: comment_count (1 of 6 props — absent: status, cid, last_comment_timestamp, last_comment_name, last_comment_uid)" => 'ℹ︎␜entity:node:article␝comment␞␟comment_count',
            "Subset of this Article's Comments: last_comment_timestamp (1 of 6 props — absent: status, cid, last_comment_name, last_comment_uid, comment_count)" => 'ℹ︎␜entity:node:article␝comment␞␟last_comment_timestamp',
            "Subset of this Article's Comments: last_comment_uid (1 of 6 props — absent: status, cid, last_comment_timestamp, last_comment_name, comment_count)" => 'ℹ︎␜entity:node:article␝comment␞␟last_comment_uid',
            "Subset of this Article's Comments: status (1 of 6 props — absent: cid, last_comment_timestamp, last_comment_name, last_comment_uid, comment_count)" => 'ℹ︎␜entity:node:article␝comment␞␟status',
