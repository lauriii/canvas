...
const Outline: React.FC<OutlineProps> = props => {
  ...
  return hoveredElementId && (
    <>
      <div ref={outlineElRef}
           className={classNames(styles.xbComponentOutline, {[styles.xbSlotOutline]: type === 'slot'})}/>
      <Grid ref={toolbarElRef} columns="2" gap="1" className={styles.xbComponentToolbar}>
        {type === 'component' && (<>
          <Button size="1" type="button" onClick={handleEditClick}>Edit</Button>
