 ...
 */
final class PropKeysConstraintValidator extends ConstraintValidator implements ContainerInjectionInterface {
  ...
  public function validate(mixed $mapping, Constraint $constraint): void {
    if (!$constraint instanceof PropKeysConstraint) {
      throw new UnexpectedTypeException($constraint, __NAMESPACE__ . '\PropKeysConstraint');
    }
