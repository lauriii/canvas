    ...
    foreach ($tree->getComponentInstanceUuids() as $uuid) {
      ...
      foreach ($prop_source_choices[$component_plugin_id] as $cpe => [
        ...
        foreach ($static_choices as $choice) {
          ...
          $element['props_editor'][$uuid][$prop_name][(string) $choice]['value'] = $source->formTemporaryRemoveThisExclamationExclamationExclamation(NULL, $uuid, $prop_name, $prop_name, $items->getEntity(), $form, $form_state);
