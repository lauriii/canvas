 ...
 * @phpstan-type ComponentClientSideTypeAny array{'id': string, 'name': string, 'category': string, 'source': string, 'default_markup': string|\Stringable, 'css': string|\Stringable, 'js_header': string|\Stringable, 'js_footer': string|\Stringable}
 * @phpstan-type ComponentClientSideTypeSdc array{'id': string, 'name': string, 'category': string, 'source': string, 'default_markup': string|\Stringable, 'css': string|\Stringable, 'js_header': string|\Stringable, 'js_footer': string|\Stringable, 'metadata': array<string, mixed>, 'field_data': array<string, mixed>, 'dynamic_prop_source_candidates': array<string, mixed>,}
 *
