 ...
 */
final class CanvasAiPageVariantSettingsForm extends ConfigFormBase {

  /**
   * {@inheritdoc}
   */
  public function getFormId(): string {
    return 'canvas_ai_page_variant_settings';
  }
  ...
  protected function getEditableConfigNames(): array {
    return ['canvas_ai.page_variant.settings'];
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state): array {
    $config = $this->config('canvas_ai.page_variant.settings');
